    ...
    <div class="container">
            ...
            <div class="col-md-12 col-lg-8 fin-feature">
                <div class="fee-distribution">
                    ...
                    <div class="fee-card">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary mit-button w-100">₹ 72,000 /-</button>
                            <ul class="fee-list">
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                    ...
                    <div class="fee-card">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary mit-button w-100">₹ 82,000 /-</button>
                            <ul class="fee-list">
                                <li>₹ 25,000 /- </li>
                                <li>Within 3 months - ₹ 28,500/-</li>
                                <li>Within 6 months - ₹ 28,500/-</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="fee-card">
                        <h5 class="card-title">Course fee - Lumpsum</h5>
                        <div class="card-body">
                            <button type="button" class="btn btn-primary mit-button w-100">&#36; 1,800 /-</button>
                            <ul class="fee-list">
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
        ...
        <div class="alert brandcolor" role="alert"><b>Note :</b><br>
            <ul class="fin-feature2" style="list-style: none;">
                ...
                <li><span class="newright-icon1"></span> Third Installment needs to be paid within 6 months from the
                    date of admission</li>
